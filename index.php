  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form action="write.php" method="post" class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
      ...
      <div class="items-center justify-between sm:col-span-2">
        <button class="inline-block rounded-lg bg-sky-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-sky-300 transition duration-100 hover:bg-sky-600 focus-visible:ring active:bg-sky-700 md:text-base">送信する</button>
      </div>
